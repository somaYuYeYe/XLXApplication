...
//    }
    ...
    private static final byte[] key = "1DF6BF44DACD4248B0B5A863".getBytes();
    private static final byte[] iv = "1DF6BF44DACD4248B0B5A863".substring(0, 8).getBytes();
    ...
    public static String decrypt(String data) {
        ...
        try {
            return new String(decrypt(hexStringToBytes(data), key, iv), "utf-8");
        } catch (Exception e) {
            e.printStackTrace();
            Log.e("http decrypt", "解密出错 e = " + e.getMessage());
        }
        return "";
    }
